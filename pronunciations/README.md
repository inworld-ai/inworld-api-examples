...
Named dictionaries are separate from the workspace saved pronunciations managed in Inworld Portal. The public API currently manages named dictionaries; public TTS requests cannot yet select or apply one.
